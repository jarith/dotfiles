...
Rule #1: If you want exception to ANY rule, YOU MUST STOP and get explicit permission from me first.
...
- If you have strong performance optimization reasons, YOU MUST ASK FOR EXPLICIT PERMISSION to implement the complex solution, with a comparison of both implementations.
...
- Comments should be evergreen and describe the code as it is. If you name something "new" or "enhanced" or "improved", you've probably made a mistake and MUST STOP and ask me what to do.
- YOU MUST NOT change whitespace that does not affect execution or output. Otherwise, use a formatting tool.

## Testing

- If testing setup is missing for the project, YOU MUST ASK for permission to add it with a description of how you going to do that.
...
- YOU MUST prefer integration and end-to-end tests over unit tests. Only external calls are allowed to be mocked. You MUST NOT mock internal functionality.
